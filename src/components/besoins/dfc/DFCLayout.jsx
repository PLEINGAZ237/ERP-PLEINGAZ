...
export default function DFCLayout({ children }) {
  ...
  return (
    // Correction ici : bg-gray-100 sur le parent pour garantir le fond gris partout
    <div className="min-h-screen flex flex-col md:flex-row bg-gray-100">
      ...
      {/* Sidebar */}
      <aside className={`
        fixed inset-y-0 left-0 z-100 w-72 bg-red-900 text-white flex flex-col transform transition-transform duration-300 ease-in-out shadow-2xl
      ...
      `}>
        <div className="p-6 border-b border-red-700 block">
          <div className="flex justify-between items-center md:block">
            <div>
              ...
              <p className="text-xs text-red-400 uppercase font-black tracking-widest mt-1">Espace DFC</p>
            </div>
        ...
        <div className="p-4 border-t border-red-800 bg-red-950/40">
          <div className="mb-4 px-2">
            ...
            <p className="text-[10px] text-red-400 uppercase font-black truncate tracking-tighter">Directeur Financier</p>
          </div>
          <button
      ...
      {/* ZONE CORRIGÉE : Fond gris sur toute la largeur et hauteur */}
